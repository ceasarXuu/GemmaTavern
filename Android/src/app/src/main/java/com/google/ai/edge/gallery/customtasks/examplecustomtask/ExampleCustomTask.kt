...
class ExampleCustomTask @Inject constructor() : CustomTask {
  override val task: Task =
    Task(
      ...
      docUrl =
        "https://github.com/ceasarXuu/GemmaTavern/blob/main/Android/src/app/src/main/java/com/google/ai/edge/gallery/customtasks/common/CustomTask.kt",
      sourceCodeUrl =
        "https://github.com/ceasarXuu/GemmaTavern/blob/main/Android/src/app/src/main/java/com/google/ai/edge/gallery/customtasks/examplecustomtask/ExampleCustomTask.kt",
      models =
        mutableListOf(
          Model(
            name = "Local model",
          ...
          Model(
            ...
            url =
              "https://raw.githubusercontent.com/ceasarXuu/GemmaTavern/refs/heads/main/README.md",
            sizeInBytes = 3798L,
